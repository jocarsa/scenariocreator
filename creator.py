...
#bpy.ops.mesh.select_all(action='TOGGLE')
#seleccionar las caras principales
bpy.ops.object.editmode_toggle()
...
bpy.ops.mesh.select_all(action='TOGGLE')
bpy.ops.object.editmode_toggle()
# Extrusion de una de las ventanas
...
bpy.ops.object.editmode_toggle()
#bpy.ops.object.editmode_toggle()
#bpy.context.active_object.data.polygons[75].select = True
#bpy.ops.object.editmode_toggle()
#zocalo
bpy.context.active_object.data.polygons[0].select = True
bpy.ops.object.editmode_toggle()
...
#bpy.ops.mesh.extrude_region_move(MESH_OT_extrude_region={"mirror":False}, TRANSFORM_OT_translate={"value":(0, 0, 0.173548), "constraint_axis":(False, False, True), "constraint_orientation":'NORMAL', "mirror":False, "proportional":'DISABLED', "proportional_edit_falloff":'SMOOTH', "proportional_size":1, "snap":False, "snap_target":'CLOSEST', "snap_point":(0, 0, 0), "snap_align":False, "snap_normal":(0, 0, 0), "gpencil_strokes":False, "texture_space":False, "remove_on_cancel":False, "release_confirm":False})
